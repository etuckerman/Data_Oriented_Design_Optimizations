...
static void collision_resolve_tile_wall(magpie::spritesheet spritesheet, tiles_t* this_tile, wall_t* wall)
{
    // velocity response
    if (wall->get_id() == WALL_ID_LEFT || wall->get_id() == WALL_ID_RIGHT)
    {
        ...
        this_tile->velocity.x = -this_tile->velocity.x;
    }
    else
    {
        ...
        // reflect y velocity
        this_tile->velocity.y = -this_tile->velocity.y;
    }
